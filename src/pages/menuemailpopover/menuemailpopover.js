 ...
 */
var MenuemailpopoverPage = /** @class */ (function () {
    function MenuemailpopoverPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    //This component opens the ComposeEmail component using a routing.
    MenuemailpopoverPage.prototype.openComposePage = function () {
        this.navCtrl.push(ComposeEmailPage);
    };
    //This component opens the InboxPage component using a routing.
    MenuemailpopoverPage.prototype.openInboxPage = function () {
        this.navCtrl.push(InboxPage);
    };
    //This component opens the SentemailPage component using a routing.
    MenuemailpopoverPage.prototype.openSentPage = function () {
        this.navCtrl.push(SentemailpagePage);
    };
    MenuemailpopoverPage = __decorate([
        Component({
    ...
    return MenuemailpopoverPage;
}());
export { MenuemailpopoverPage };
//# sourceMappingURL=menuemailpopover.js.map
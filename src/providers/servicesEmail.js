...
var servicesEmail = /** @class */ (function () {
    function servicesEmail() {
        /*
    ...
    */
    servicesEmail.prototype.getEmails = function () {
        return this.emails;
    };
    servicesEmail = __decorate([
        Injectable()
    ], servicesEmail);
    return servicesEmail;
}());
export { servicesEmail };
//# sourceMappingURL=servicesEmail.js.map